...
images_zero = "/home/pi/rpi-stereo-vision/calibration/camera0/*.jpg"
images_one = "/home/pi/rpi-stereo-vision/calibration/camera1/*.jpg"
...
def charuco_calibration(images_glob : str, cam : int):
	...
	if cam == 0:
		cv2.imwrite(f"/home/pi/rpi-stereo-vision/calibration/camera0/opencv/{counter}.jpg", image)
	else: 
		cv2.imwrite(f"/home/pi/rpi-stereo-vision/calibration/camera1/opencv/{counter}.jpg", image)
