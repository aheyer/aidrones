...
The goal of this chapter is to provide beginners with an easily understandable introduction to FPV drones. It aims to enable them to identify the components needed to design and build drones for their own projects. This provides the foundation for selecting and configuring the required software (see Chapter~\ref{KapitelSoftware}) and implementing AI functionality using (see Chapter~\ref{KapitelObjekterkennung}, \ref{KapitelAutopilot}, and \ref{KapitelFollowme}).
...
Larger motors (e.g., 22xx, 23xx, 24xx) for drones of 5 inches and above typically feature an M5 shaft with a 5\,mm diameter for propeller mounting (see Figure~\ref{AbbildungTMotor2306KV2400}). The propellers are placed directly onto the motor shaft and secured with a nut. 

\colger

Größere Motoren (z. B. 22xx, 23xx, 24xx) für Drohnen ab 5 Zoll besitzen zur Propelleraufnahme meist eine M5-Welle mit 5\,mm Durchmesser (siehe Abbildung~\ref{AbbildungTMotor2306KV2400}). Die Propeller werden direkt auf die Motorwelle gesteckt und mit einer Mutter gesichert. 

\coleng

Smaller motors (e.g., 13xx, 14xx, 18xx) for drones up to 3.5 inches usually have much smaller shafts of 1.5\,mm in diameter, where the propellers are attached with two screws (see Figure~\ref{AbbildungTMotor1604KV2850}). Motors for medium-sized drones (e.g., 20xx, 21xx) with 3.5 or 4-inch propellers are available in both M5 and 1.5\,mm shaft variants.

\colger

Kleinere Motoren (z. B. 13xx, 14xx, 18xx) für Drohnen bis 3,5 Zoll haben in der Regel eine deutlich kleinere Welle mit 1,5\,mm Durchmesser, an der die Propeller mit zwei Schrauben befestigt werden (siehe Abbildung~\ref{AbbildungTMotor1604KV2850}). Motoren (z. B. 20xx, 21xx) für mittelgroße Drohnen (3,5 oder 4 Zoll) sind sowohl mit M5-Wellen als auch mit 1,5\,mm-Wellen erhältlich.
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{TMotor_V2306_KV2400_White_Silver_4S_oben.png}
    \vspace{0pt} % sorgt für Top-Ausrichtung
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{TMotor_V2306_KV2400_White_Silver_4S_unten.png}
    \vspace{0pt}
  \end{minipage}
  \caption{T-Motor 2306 KV2400 Motor with an M5 Shaft}
  \label{AbbildungTMotor2306KV2400}
\end{figure}
\FloatBarrier
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{TMotor_Pacer_P1604_KV2850_4S_6S_Silver_Blue_Motor_oben.png}
    \vspace{0pt} % sorgt für Top-Ausrichtung
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{TMotor_Pacer_P1604_KV2850_4S_6S_Silver_Blue_Motor_unten.png}
    \vspace{0pt}
  \end{minipage}
  \caption{T-Motor 1604 KV2850 4-6S Motor with a 1.5\,mm Shaft}
  \label{AbbildungTMotor1604KV2850}
\end{figure}
\FloatBarrier
...
The motor shown in Figure~\ref{AbbildungTMotor2306KV2400} has a hole spacing of 12\,mm, while the motor shown in Figure~\ref{AbbildungTMotor1604KV2850} has a hole spacing of 7\,mm.

\colger

Der in Abbildung~\ref{AbbildungTMotor2306KV2400} gezeigte Motor weist einen Lochabstand von 12\,mm auf, während der in Abbildung~\ref{AbbildungTMotor1604KV2850} dargestellte Motor einen Lochabstand von 7\,mm besitzt.
...
For example, a 1500 mAh LiPo battery (see Figure~\ref{AbbildungLiPoAkku}) with a C-rate of 100 can deliver \(1.5\,\mbox{Ah} \times 100 = 150\,\mbox{A}\) of continuous current.

\colger

Ein 1500 mAh LiPo-Akku (siehe Abbildung~\ref{AbbildungLiPoAkku}) mit einem C-Wert von 100 kann somit \(1{,}5\,\mbox{Ah} \times 100 = 150\,\mbox{A}\) Dauerstrom liefern.
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \vspace{0pt}
  \end{minipage}
  \caption{4S Lithium-Polymere Battery with 1500\,mAh Capacity and 100\,C Capacity Rate}
...
For example, a 2500 mAh Li-Ion battery (see Figure~\ref{AbbildungLiIonAkku12C}) with a C-rate of 12 can deliver \(2.5\,\mbox{Ah} \times 12 = 30\,\mbox{A}\) of continuous current.

\colger

Ein 2500 mAh Li-Ion-Akku (siehe Abbildung~\ref{AbbildungLiIonAkku12C}) mit einem C-Wert von 12 kann somit \(2{,}5\,\mbox{Ah} \times 12 = 30\,\mbox{A}\) Dauerstrom liefern.

\colende

\begin{figure}[htb]
  \centering
    \includegraphics[width=\linewidth]{GAONENG_LiIon_2500mAh_4S_4S1P_12C_front_crop.png}
  \caption{4S Lithium-Ion Battery with 2500\,mAh Capacity and 12\,C Capacity Rate}
  \label{AbbildungLiIonAkku12C}
\end{figure}
\FloatBarrier
...
\label{TabelleAkkus}
\begin{tabularx}{\textwidth}{X@{\hskip 8mm}X@{\hskip 8mm}r@{\hskip 8mm}r@{\hskip 8mm}r}
\toprule
...
As battery capacity increases, not only does flight time improve, but total weight also increases (see Table~\ref{TabelleAkkusGewicht}). Very small 4S batteries with a capacity of 450 mAh weigh around 60 g, while the battery shown in Figure~\ref{AbbildungLiPoAkku} with a capacity of 1500 mAh weighs about 185 g. Higher total weight also affects flight characteristics.

\colger

Mit steigender Kapazität eines Akkus erhöht sich nicht nur die Flugdauer, sondern auch das Gesamtgewicht (siehe Tabelle~\ref{TabelleAkkusGewicht}). Sehr kleine 4S-Akkus mit 450 mAh Kapazität wiegen etwa 60 g, während der in Abbildung~\ref{AbbildungLiPoAkku} gezeigte Akku mit 1500 mAh rund 185 g wiegt. Ein höheres Gesamtgewicht beeinflusst auch das Flugverhalten.
...
\begin{table}[htb!]
\centering
\captionabove{Weight of some Lithium-Polymere (LiPo) and Lithium-Ion (Li-Ion) Batteries}
\label{TabelleAkkusGewicht}
\begin{tabularx}{\textwidth}{Xllrrrlr}
\toprule
Technology & Type & Vendor & Capacity & C-rate & Voltage & Connector & weight   \\
\midrule
LiPo   & 4S & Tattu              & 450mAh   & 75C  & 14.8V & XT30 & \(\sim\) 55 g   \\
LiPo   & 4S & Gaoneng            & 650mAh   & 120C & 15.2V & XT30 & \(\sim\) 70 g   \\
LiPo   & 4S & Tattu              & 650mAh   & 95C  & 14,8V & XT30 & \(\sim\) 80 g   \\
LiPo   & 4S & Tattu              & 750mAh   & 95C  & 14,8V & XT30 & \(\sim\) 85 g   \\
LiPo   & 4S & Gaoneng            & 850mAh   & 120C & 15.2V & XT30 & \(\sim\) 90 g   \\
LiPo   & 4S & Tattu              & 850mAh   & 95C  & 14.8V & XT30 & \(\sim\) 110 g   \\
LiPo   & 4S & Tattu Funfly       & 1300mAh  & 100C & 14.8V & XT60 & \(\sim\) 150 g   \\
LiPo   & 4S & CNHL               & 1500mAh  & 100C & 14.8V & XT60 & \(\sim\) 185 g   \\
LiPo   & 4S & CNHL               & 2000mAh  & 100C & 14.8V & XT60 & \(\sim\) 235 g   \\
\midrule
LiPo   & 6S & Tattu R-Line       & 650mAh   & 95C  & 22.2V & XT30 & \(\sim\) 120 g   \\
LiPo   & 6S & CNHL               & 1200mAh  & 120C & 22.2V & XT60 & \(\sim\) 210 g   \\
LiPo   & 6S & Tattu Funfly       & 1300mAh  & 100C & 22.2V & XT60 & \(\sim\) 220 g   \\
LiPo   & 6S & CNHL               & 1300mAh  & 130C & 22.2V & XT60 & \(\sim\) 230 g   \\
LiPo   & 6S & CNHL               & 1500mAh  & 130C & 22.2V & XT60 & \(\sim\) 265 g   \\
\midrule
Li-Ion & 4S (4S1P) & Gaoneng     & 2500mAh  & 12C  & 14.8V & XT60  & \(\sim\) 200 g   \\
Li-Ion & 4S (4S1P) & GEPRC       & 3000mAh  & 15C  & 14.8V & XT60  & \(\sim\) 200 g   \\
Li-Ion & 4S (4S1P) & RACEpow     & 4000mAh  & 10C  & 14.8V & XT60  & \(\sim\) 290 g   \\
Li-Ion & 4S (4S2P) & RACEpow     & 10000mAh & 10C  & 14.8V & XT60 & \(\sim\) 600 g   \\
\midrule 
Li-Ion & 6S (6S1P) & RACEpow     & 4000mAh  & 10C  & 22.2V & XT60 & \(\sim\) 430 g   \\
Li-Ion & 6S (6S1P) & GEPRC       & 4000mAh  & 15C  & 22.2V & XT60 & \(\sim\) 445 g   \\
Li-Ion & 6S (6S2P) & RACEpow     & 8000mAh  & 10C  & 22.2V & XT60 & \(\sim\) 860 g   \\
Li-Ion & 6S (6S2P) & GEPRC       & 8000mAh  & 15C  & 22.2V & XT60 & \(\sim\) 890 g   \\
\bottomrule
\end{tabularx}
\end{table}
\FloatBarrier
...
XT30 connectors and sockets are designed for a maximum continuous current of 30 A and peak currents of 40-60\,A. XT60 connectors are rated for a maximum continuous current of 60 A and peak currents of 80-120\,A, depending on the manufacturer, the wires used, the quality of the solder joints, and the thermal load. XT90 connectors are designed for high-current applications, supporting continuous currents of up to 90\,A and peak currents exceeding 150\,A.

\colger

XT30-Buchsen und -Stecker sind für einen maximalen Dauerstrom von 30\,A und einen Spitzenstrom von 40-60\,A ausgelegt. XT60-Stecker sind für einen maximalen Dauerstrom von 60,A und einen Spitzenstrom von 80-120\,A ausgelegt, abhängig vom Hersteller, den verwendeten Leitungen, der Qualität der Lötverbindungen und der thermischen Belastung. XT90-Stecker sind für Hochstromanwendungen konzipiert und für einen Dauerstrom von bis zu 90\,A sowie für über 150\,A Spitzenstrom ausgelegt.
...
Common GPS modules (see Figure~\ref{AbbildungGPSModuleM1005883}) with an integrated magnetic compass are typically between 20\(\times\)20 mm and 25\(\times\)25 mm in size.

\colger

Gängige GPS-Module (siehe Abbildung~\ref{AbbildungGPSModuleM1005883}) mit integriertem magnetischem Kompass sind in der Regel zwischen 20\(\times\)20 mm und 25\(\times\)25 mm groß.
...
\begin{figure}[htbp]
  ...
  \label{AbbildungGPSModuleM1005883}
\end{figure}
\FloatBarrier
...
\renewcommand{\deutschertitel}{Fernsteuerung (Sender)}
...
Die verwendete Fernsteuerung muss dasselbe Protokoll implementieren wie der eingesetzte Empfänger und denselben Frequenzbereich nutzen. Zu den Herstellern von mit dem ELRS-Protokoll kompatiblen Fernsteuerungen gehören RadioMaster, Axisflying und Jumper.
...
ELRS-Fernsteuerungen (Sender) verwenden ExpressLRS als Firmware für das Funkprotokoll und das Sendermodul sowie EdgeTX als Betriebssystem, eine modernisierte Variante von OpenTX. EdgeTX erzeugt die Steuersignale, und ExpressLRS überträgt sie.
...
HDZero Goggle 2\textsuperscript{a}    & 1920x1080\,px & OLED    & analog A/V + HDMI output \\
HDZero BoxPro\textsuperscript{a}      & 1280x720\,px  & LCD     & analog A/V + HDMI output \\
Rotorama 800D                         & 800x480\,px   & LCD     & no video output          \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\footnotesize
\item[a] HDZero goggles are designed for the digital HDZero video system, but also include an analog receiver
\end{tablenotes}
\end{threeparttable}
\end{table}
\FloatBarrier
...
The ability to output the video signal through an interface and process it in real time on another device is particularly interesting for many potential AI projects. Although numerous FPV goggles feature an HDMI port, it is typically used only for playing back video from external sources. Only few FPV goggles currently support video output via HDMI.

\colger

Besonders die Möglichkeit, das Videosignal über eine Schnittstelle auszugeben und in einem anderen Gerät in Echtzeit zu verarbeiten, ist für viele denkbare KI-Projekte eine interessante Option. Zahlreiche Videobrillen verfügen zwar über einen HDMI-Port, dieser dient jedoch ausschließlich zum Abspielen von Videos von externen Quellen. Eine Ausgabe des Videosignals über HDMI unterstützen nur wenige gängigen FPV-Brillen.

\coleng

Most FPV goggles include a 3.5 mm AV port (see Figure~\ref{AbbildungBrilleAVPort}) that allows analog video and audio input and output. Using a video capture device, the output signal can be transmitted to a computer for further processing.

\colger

Die meisten Videobrillen verfügen über eine 3,5 mm AV-Schnittstelle (siehe Abbildung~\ref{AbbildungBrilleAVPort}), über die Video und Audio analog ein- und ausgegeben werden können. Mithilfe eines Videograbbers kann das Ausgabesignal an einen Computer weitergeleitet und dort verarbeitet werden.

\colende

\begin{figure}[htb]
  \centering
    \includegraphics[width=\linewidth]{SKYZONE_04X_PRO_IMG_5179.png}
  \caption{A/V Port a Skyzone SKY04X Pro FPV Goggle)}
  \label{AbbildungBrilleAVPort}
\end{figure}
\FloatBarrier
