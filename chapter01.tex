...
Dieses Kapitel stellt die wichtigen Hardware-Komponenten zum Bau von FPV-Drohnen vor. Zusätzliche Hardware zur Realisierung einer KI-Funktionalität ist Teil von Kapitel~\ref{KapitelKI}. 
...
\begin{figure}[htb]
  ...
  \caption{Components of FPV Drone)}
...
Zum Vergleich ein anderer Flugcontroller, der in Abbildung~\ref{AbbildungFlywooFCGOKUGN745AIO} gezeigte Flywoo GOKU GN745 AIO 45A, verfügt über sieben UART-Schnittstellen, von denen keine für die USB-Schnittstelle belegt wird. Dadurch sind nach Anschluss der üblicherweise vorhandenen Komponenten Videosender, Empfänger und GPS-Modul vier UART-Schnittstelle für weitere Sensoren und Aktoren verfügbar.
...
\captionabove{Overview of UART Interfaces of some Flight Controllers}
\scriptsize
...
SpeedyBee F4V3 Stack           & \cellcolor{Gray}VTX   & \cellcolor{Gray}Receiver        & \cellcolor{green}available & \cellcolor{Gray}MSP\textsuperscript{a} & \cellcolor{Gray}Telem.\textsuperscript{c} & \cellcolor{Gray}GPS & --- & ---     \\
Flywoo F722 PRO MINI V2        & \cellcolor{yellow}available\textsuperscript{b} & \cellcolor{green}available & \cellcolor{Gray}VTX & \cellcolor{Gray}Receiver & \cellcolor{Gray}GPS & \cellcolor{Gray}Telem.\textsuperscript{c} & --- & --- \\
...
Flywoo GN745 AIO V3            & \cellcolor{green}available & \cellcolor{Gray}Receiver & \cellcolor{Gray}VTX       & \cellcolor{green}available  & \cellcolor{green}available  & \cellcolor{Gray}GPS & \cellcolor{green}available & --- \\
