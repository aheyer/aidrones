...
Bei einem Pitch von 4,3'' pro Umdrehung und 3000\,U/min gibt es einen theoretischen Weg von von \(3000 \times 4,3 = 12.900\,Zoll/min\). Ein Zoll entspricht 25,4\,mm. Somit ist der theoretischen Weg pro Zeit, also die Geschwindigkeit: \(12.900\times 0,0254 \approx 327,7\,m/min\) bzw. \(327,7\,m/min / 60 \approx 5,46\,m/s\).
...
Diese theoretischen Werte werden in der Realität durch Schlupfverluste um 20-30\% verringert. Der Grund dafür ist die Physik der Luftströmung. Luft ist kein festes Medium, sondern gibt nach und ist beweglich. Durch dieses ausweichen und verwirbeln, \textsl{rutscht} immer ein Teil der Luft weg und der Propeller erreicht in der Praxis weniger Vortrieb als in der Theorie. 
