...
(as illustrated in Figure~\ref{ErasingBoardUsingSTM32}). Wait for the programming process to finish, then disconnect and power-cycle the board to complete the installation.
