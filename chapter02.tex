...
Of the flight controller firmware options presented in this document, ArduPilot requires the most memory. Ideally, 2\,MB of flash memory should be available for proper operation. This is provided only by flight controllers equipped with an H743 microcontroller. With 1\,MB of flash memory (as found in F405 and F745 microcontrollers), operation is possible but with a reduced feature set. With only 512 kB (F411 and F722 microcontrollers), ArduPilot cannot be used at all.
